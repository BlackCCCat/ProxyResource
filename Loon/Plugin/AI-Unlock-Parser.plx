...
[Script]
generic script-path=https://raw.githubusercontent.com/BlackCCCat/ProxyResource/main/Loon/Script/ai_unlock.js,tag=AIUnlockParser,timeout=150,argument=[{chatgpt},{claude},{gemini},{depth},{strict},{marker},{tagMode},{source},{sortFirst},{dropFailed},{concurrency},{timeout},{budget},{cacheTTL}]
